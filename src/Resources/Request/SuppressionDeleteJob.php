...
/**
 * POST /api/profile-suppression-bulk-delete-jobs: lifts manual suppressions from email marketing.
 *
 * Profiles are identified by email only. Passing a list or segment id unsuppresses
 ...
 */
class SuppressionDeleteJob extends TypedResource
{
